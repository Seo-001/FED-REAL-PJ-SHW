...
import subTemp from "./tempData/sub-temp.js";
...
Vue.component("sub-comp", {
    template: subTemp.tsub,
}); ///////////////뷰 컴포넌트 상단영역 Vue Component////////////////

// Vue.component(내가지은요소명, { 옵션 })
// 그림 설명
Vue.component("sub-main", {
    template: subTemp.tmain,
}); ///////////////뷰 컴포넌트 상단영역 Vue Component////////////////

// 6. 상세보기 영역 컴포넌트
Vue.component("detail-comp", {
    template: subTemp.detail,
    methods: {
        test() {
            //0. 기본 이동막기
            // e.preventDefault();
            $("#detail").removeClass("on").hide();
            // console.log("ddddd")
        },
    },
    mounted() {
...
new Vue({
    ...
    methods: {
        ...
        //         $("#detail").removeClass("on");
        //         // console.log("ddddd")
        //         // this.closet("section").removeClass("on");
        //     });
        // },
        // 안됨
    },
    ...
    mounted: function () {
        ...
        $(".grid img").click(function (e) {
            ...
            let ginfo = $(this).attr("src").split("_")[1].split(".png")[0];

            // console.log("상품정보:1", ginfo);

            let int = parseInt(ginfo);

            // 소제목
            store.state.gnum = int;
    ...
    created: function () {
        // DOM 연결전 데이터 가공작업
        // console.log("created구역");
        console.log("555", store.state.gnbData);
    },
}); /////////////상단영역 뷰 인스턴스//////////////
